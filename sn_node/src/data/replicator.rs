...
use sn_interface::types::{Peer, ReplicatedDataAddress};
...
pub(crate) struct ReplicationJob {
    pub(crate) data_address: ReplicatedDataAddress,
...
pub(crate) struct ReplicationQueue {
    ...
    queue: Mutex<BTreeMap<ReplicatedDataAddress, BTreeSet<Peer>>>,
}
...
impl ReplicationQueue {
    ...
    pub(crate) fn enqueue(&self, recipient: Peer, complementing_data: Vec<ReplicatedDataAddress>) {

...
impl Node {
    ...
    pub(crate) fn get_missing_data_for_node(
        ...
        let cmd = crate::data::Cmd::EnqueueComplementingData {
            peer,
            currently_at_peer,
            other_peers,
        };
    ...
    pub(crate) fn ask_peers_for_data(
        &self,
        currently_held_data: Vec<ReplicatedDataAddress>,
    ) -> Cmd {
        ...
        let msg = SystemMsg::NodeCmd(NodeCmd::ComplementMissingData(currently_held_data));
